...
const S: Record<string, Bi> = {
  ...
  aiIntro: {
    hi: 'API कुंजी डालने पर हर विषय के लिए असली AI सामग्री, फोटो से पन्ना-पहचान और 12 भाषाओं में समझाना चालू हो जाता है। कुंजी सिर्फ इसी फ़ोन पर रहती है।',
    en: 'Add an API key to turn on real AI: material for any topic, reading photographed pages, and explanations in all 12 languages. The key stays on this phone only.',
  },
  ...
  aiOn: { hi: 'AI चालू है', en: 'AI is on' },
  aiOff: { hi: 'AI बंद है — बिना इंटरनेट/कुंजी के ऐप अपने भीतर के प्रश्न-बैंक से चलता है', en: 'AI is off — without internet/key the app runs on its built-in question bank' },
