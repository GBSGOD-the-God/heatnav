...
const S: Record<string, Bi> = {
  ...
  aiIntro: {
    hi: 'यह हिस्सा ज़िला या संस्था के लिए है, शिक्षिका के लिए नहीं। अगर किसी के पास पहले से Anthropic कुंजी है तो वह यहाँ डाल सकते हैं — तब किसी भी विषय पर सामग्री और बेहतर व्याख्या मिलती है। कुंजी सिर्फ इसी फ़ोन पर रहती है और इसका शुल्क उसी खाते पर लगता है। बिना कुंजी के भी ऐप का हर काम पूरा चलता है।',
    en: 'This section is for a district or organisation, not for the teacher. If someone already has an Anthropic key they can paste it here, which adds material for any topic and richer explanations. The key stays on this phone and is billed to that account. Everything in the app works fully without one.',
  },
  ...
  setKeyEmpty: { hi: 'खाली — ज़रूरी नहीं', en: 'Empty — not required' },
  setClearKey: { hi: 'कुंजी हटाएँ', en: 'Remove key' },
  setKeyCleared: { hi: 'कुंजी हटा दी गई', en: 'Key removed' },
  aiKeyLabel: { hi: 'Anthropic API कुंजी', en: 'Anthropic API key' },
  aiKeyHint: { hi: 'console.anthropic.com से कुंजी बनाएँ', en: 'Create a key at console.anthropic.com' },
